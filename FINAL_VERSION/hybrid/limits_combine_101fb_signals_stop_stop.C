...
//=========  (Sat May  4 17:43:27 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0001928596);
   Graph_Graph02->SetMaximum(0.0005576607);
   ...
   Graph_Graph13->SetMinimum(0.0002403083);
   Graph_Graph13->SetMaximum(0.0004753573);
   ...
   Graph_median_expected4->SetMinimum(0.0002816451);
   Graph_median_expected4->SetMaximum(0.0004103942);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.472828,-1111,1.472828,0.0003051905);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.468945,0,1.468945,0.0003124042);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.443945,0,"  1.47 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.522828,0,"  1.47 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
