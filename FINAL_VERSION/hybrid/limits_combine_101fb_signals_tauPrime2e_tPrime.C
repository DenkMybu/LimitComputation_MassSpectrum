...
//=========  (Sat May  4 17:43:29 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(3.392631e-05);
   Graph_Graph02->SetMaximum(0.0003187434);
   ...
   Graph_Graph13->SetMinimum(4.672419e-05);
   Graph_Graph13->SetMaximum(0.0002293957);
   ...
   Graph_median_expected4->SetMinimum(5.935091e-05);
   Graph_median_expected4->SetMaximum(0.0001598851);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.406399,-1111,1.406399,7.246513e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.405438,0,1.405438,7.280655e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.400438,0,"  1.41 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.456399,0,"  1.41 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
