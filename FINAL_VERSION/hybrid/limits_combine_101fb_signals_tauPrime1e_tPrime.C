...
//=========  (Sat May  4 17:43:32 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(4.356307e-05);
   Graph_Graph02->SetMaximum(0.0002000577);
   ...
   Graph_Graph13->SetMinimum(5.579842e-05);
   Graph_Graph13->SetMaximum(0.0001358277);
   ...
   Graph_median_expected4->SetMinimum(6.514289e-05);
   Graph_median_expected4->SetMaximum(9.453937e-05);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.143278,-1111,1.143278,7.527327e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.138943,0,1.138943,7.706534e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.133943,0,"  1.14 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.193278,0,"  1.14 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
