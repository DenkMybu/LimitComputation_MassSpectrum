...
//=========  (Sat May  4 17:43:47 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(5.267716e-05);
   Graph_Graph02->SetMaximum(0.002237739);
   ...
   Graph_Graph13->SetMinimum(5.354205e-05);
   Graph_Graph13->SetMaximum(0.00159638);
   ...
   Graph_median_expected4->SetMinimum(5.705582e-05);
   Graph_median_expected4->SetMaximum(0.001114668);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.8475306,-1111,0.8475306,8.332743e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.8685361,0,0.8685361,7.038032e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.8635361,0,"  0.87 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.8425306,0,"  0.85 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
